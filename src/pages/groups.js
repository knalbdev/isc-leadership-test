          ...
          ${GROUPS.map((g, i) => {
            ...
            return `
              <button onclick="handleGroupSelect(${g.id})"
                ...
                <!-- Number badge -->
                <div class="flex h-9 w-9 items-center justify-center rounded-xl text-base font-black text-white mb-3 shadow-sm"
      ...
      <div class="mx-auto flex h-14 max-w-5xl items-center justify-between px-4 sm:px-6">
        ...
        <div class="flex items-center gap-1">
          <button onclick="openSettings()" title="Pengaturan"
            class="flex items-center gap-1.5 text-xs text-stone-500 hover:text-stone-800 transition-colors px-2 py-1 rounded-lg hover:bg-stone-100">
          ...
          <button onclick="handleLogout()" class="flex items-center gap-1.5 text-xs text-stone-500 hover:text-stone-800 transition-colors px-2 py-1 rounded-lg hover:bg-stone-100">
            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
